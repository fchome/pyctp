...
cimport ctpCStruct
from ctpCStruct cimport CThostFtdcFensUserInfoField, CThostFtdcReqUserLoginField, CThostFtdcUserLogoutField


cdef extern from "MdSpi.h":
    cdef cppclass MdSpi

cdef extern from "MdApi.h":
    cdef cppclass MdApi:
        MdApi() except +
        ...
        MdApi(char *pszFlowPath, bint bIsUsingUdp, bint bIsMulticast) except +
